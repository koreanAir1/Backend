...
public class CommonMenuController {
    ...
    @Operation(summary = "공통 메뉴 상세 조회", description = "특정 ID의 공통 메뉴 정보를 조회합니다", security = @SecurityRequirement(name = "bearerAuth"))
    ...
    @Operation(summary = "전체 공통 메뉴 조회", description = "모든 공통 메뉴 목록을 조회합니다", security = @SecurityRequirement(name = "bearerAuth"))
    ...
    @Operation(summary = "요일별 공통 메뉴 조회", description = "특정 요일의 공통 메뉴를 조회합니다", security = @SecurityRequirement(name = "bearerAuth"))
    ...
    @Operation(summary = "공통 메뉴 추가", description = "새로운 공통 메뉴를 추가합니다", security = @SecurityRequirement(name = "bearerAuth"))
    ...
    @Operation(summary = "공통 메뉴 수정", description = "기존 공통 메뉴 정보를 수정합니다", security = @SecurityRequirement(name = "bearerAuth"))
    ...
    @Operation(summary = "공통 메뉴 삭제", description = "공통 메뉴를 삭제합니다", security = @SecurityRequirement(name = "bearerAuth"))
