...
public class FeedbackController {
    ...
    @Operation(summary = "피드백 추가", description = "메뉴에 대한 피드백을 추가합니다", security = @SecurityRequirement(name = "bearerAuth"))
    ...
    @Operation(summary = "피드백 조회", description = "특정 ID의 피드백 정보를 조회합니다", security = @SecurityRequirement(name = "bearerAuth"))
    ...
    @Operation(summary = "전체 피드백 통계 조회", description = "모든 메뉴의 피드백 통계를 조회합니다", security = @SecurityRequirement(name = "bearerAuth"))
